...
public class TileFactory {
    ...
    private Map<Character, Supplier<Enemy>> initEnemies() {
        List<Supplier<Enemy>> enemies = Arrays.asList(
                ...
                () -> new Trap('B', "Bonus Backend.Tiles.Units.Enemies.Trap", 1, 1, 1, 250,  1, 10),
                () -> new Trap('Q', "Queen's Backend.Tiles.Units.Enemies.Trap", 250, 50, 10, 100, 3, 10),
                ...
                () -> new Trap('D', "Death Backend.Tiles.Units.Enemies.Trap", 500, 100, 20, 250, 1, 10)
        );
